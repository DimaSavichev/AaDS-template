...
После создания реквеста, откройте его и справа в разделе reviewers добавьте DimaSavichev (это поможет мне быстрее видеть, что вы сдали задачу а не бегать по вашим репозиториям в поисках того, что можно проверить)
...
**Важно:** после каждой итерации исправления ошибок нужно засылать новы код в Яндекс.Контест и прикреплять новую ссылку на посылку
